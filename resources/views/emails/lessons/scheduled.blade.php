...
Your music teacher {{ $teacher->first_name }} {{ $teacher->last_name }} has <u>{{ is_null($status) ? 'Scheduled' : $status }}</u> your {{ $student->instrument }} lessons for the following day(s).
