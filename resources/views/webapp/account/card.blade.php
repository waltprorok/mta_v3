                        ...
                        <div class="col-md-6">
                            <div class="card-body">
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item"><i class="fa fa-credit-card-alt" style="padding-right: 10px;" aria-hidden="true"></i>{{ ucfirst(Auth::user()->pm_type) }} ending in {{ Auth::user()->pm_last_four }}</li>
