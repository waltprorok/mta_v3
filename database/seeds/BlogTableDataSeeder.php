    ...
    public function run()
    {
        Blog::query()->insert([
            [
                ...
                'body' => 'MTA love the magic that Laravel provides right out of the box. Modern toolkit. Pinch of magic. An amazing ORM, painless routing, powerful queue library, and simple authentication give you the tools you need for modern, maintainable PHP. We sweat the small stuff to help you deliver amazing applications. For the security and basic peace of mind we went with an Amazing Framework that keeps getting better with every release.',
